...
public class BaseAppHelper {
     ...
     * 本地歌曲列表
     */
    private final List<AudioBean> mMusicLocalList = new ArrayList<>();
    /**
     * 歌单列表
     */
    ...
    public List<AudioBean> getMusicLocalList() {
        return mMusicLocalList;
    }


    public void setLocalMusicList(List<AudioBean> list) {
        mMusicLocalList.clear();
        mMusicLocalList.addAll(list);
    }
