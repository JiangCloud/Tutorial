package com.cloud.xtilus.makingfriends.common.manager;
...
import com.cloud.xtilus.makingfriends.section.chat.activity.LiveActivity;
...
public class PushAndMessageHelper {
    ...
    private static boolean isDuringMediaCommunication() {
        UserActivityLifecycleCallbacks lifecycle = MakingFriendApplication.getInstance().getLifecycleCallbacks();
    ...
    public static Uri getImageForwardUri(EMImageMessageBody body) {
        ...
        Context context = MakingFriendApplication.getInstance().getApplicationContext();
    ...
    public static String getSystemMessage(InviteMessage msg) {
        ...
        String messge;
        Context context = MakingFriendApplication.getInstance();
    ...
    public static String getSystemMessage(Map<String, Object> msg)  throws NullPointerException {
        ...
        switch (status) {
            ...
            case GROUPINVITATION:
                ...
                messge = String.format(builder.toString(), msg.get(DemoConstant.SYSTEM_MESSAGE_FROM), name);
                break;
            case GROUPINVITATION_ACCEPTED:
            case GROUPINVITATION_DECLINED:
            case MULTI_DEVICE_GROUP_APPLY_ACCEPT:
    ...
    private static void sendMessage(EMMessage message) {
        message.setMessageStatusCallback(new EMCallBack() {
            ...
            public void onSuccess() {
                LiveDataBus.get().with(DemoConstant.MESSAGE_FORWARD)
                        .postValue(new EaseEvent(MakingFriendApplication.getInstance().getString(R.string.has_been_send), EaseEvent.TYPE.MESSAGE));
            }
