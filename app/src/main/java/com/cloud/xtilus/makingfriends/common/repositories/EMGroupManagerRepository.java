...
public class EMGroupManagerRepository extends BaseEMRepository{
            ...
            protected void createCall(@NonNull ResultCallBack<LiveData<List<EaseUser>>> callBack) {
                ...
                DemoHelper.getInstance().getGroupManager().asyncGetGroupFromServer(groupId, new EMValueCallBack<EMGroup>() {
                    ...
                    public void onSuccess(EMGroup value) {
                        ...
                        getMembersUserInfo(members,callBack);
     ...
     *
     * @param members
     * @return List<EaseUser>
     */


    private void getMembersUserInfo(List<String> members,ResultCallBack<LiveData<List<EaseUser>>> callBack) {


        if(!members.isEmpty()) {
            Map<String,Object> params = new HashMap<String,Object>();
            params.put("userNames", members);
                    ...
                    if (listResponseBean.getRet_code()==200) {
                        ...
                        if(users!=null&&!users.isEmpty()){
                            ...
                            for (int i = 0; i < users.size(); i++) {
                                EaseUser user = new EaseUser(finalMembers.get(i));
                                ...
                                EMLog.d("finalMembers","======"+finalMembers.get(i));
