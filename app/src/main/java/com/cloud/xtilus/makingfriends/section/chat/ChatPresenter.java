package com.cloud.xtilus.makingfriends.section.chat;
...
import com.cloud.xtilus.makingfriends.common.repositories.EMGroupManagerRepository;
...
public class ChatPresenter extends EaseChatPresenter {
    ...
    private ChatPresenter() {
        appContext = MakingFriendApplication.getInstance();
                ...
                switch (msg.what) {
                    ...
                    case HANDLER_START_CONFERENCE:
                        ...
                        if(obj instanceof EMMessage) {
                            ...
                            if(!MakingFriendApplication.getInstance().getLifecycleCallbacks().isFront()){
    ...
    private synchronized boolean isAppLaunchMain() {
        List<Activity> activities = MakingFriendApplication.getInstance().getLifecycleCallbacks().getActivityList();
    ...
    public void onCmdMessageReceived(List<EMMessage> messages) {
        ...
        for (EMMessage message : messages) {
            ...
            if(action.equals("6000")) {

                try {
                    JSONObject jsonObject = new JSONObject(String.valueOf(message.ext().get("groupInfo")));
                    ...
                    //更新缓存
                    DemoHelper.getInstance().updateGroupName(groupId,groupName);
                    Log.d("ext", "groupData===========-----------" + groupName);
            ...
            if(action.equals("7000")){
                try {
                    JSONObject jsonObject =new  JSONObject(String.valueOf(message.ext().get("data")));
                    JSONObject   momentsData  =jsonObject.getJSONObject("data");
                    Log.d("ext","momentsData===================="+momentsData);
                    int typeInt = momentsData.getInt("type");
                    ...
                    MomentsMessageDao momentsMessageDao = new MomentsMessageDao(appContext);
                    momentsMessageDao.savaMomentsMessage(momentsMessage);
                    LocalBroadcastManager.getInstance(appContext).sendBroadcast(new Intent(IMAction.ACTION_MOMENTS));
                    EMLog.d(TAG, "typeInt:"+typeInt);
                } catch (Exception e) {
                    EMLog.d(TAG, "momentsMessage:" + e.getMessage());
                    e.printStackTrace();
                }
    ...
    private class ChatGroupListener extends EaseGroupListener {
        ...
        public void onUserRemoved(String groupId, String groupName) {
            ...
            msg.addBody(new EMTextMessageBody(context.getString(R.string.demo_group_listener_onUserRemoved, groupName)));
        ...
        public void onMuteListAdded(String groupId, List<String> mutes, long muteExpire) {
            ...
            EMMessage msg = EMMessage.createReceiveMessage(EMMessage.Type.TXT);
            msg.setChatType(EMMessage.ChatType.GroupChat);
            // msg.setFrom(administrator);
            msg.setTo(groupId);
            msg.setMsgId(UUID.randomUUID().toString());
            msg.setAttribute(DemoConstant.EM_NOTIFICATION_TYPE, true);
            msg.addBody(new EMTextMessageBody(context.getString(R.string.demo_group_listener_onMuteListAdded, content)));
            msg.setStatus(EMMessage.Status.SUCCESS);
            // save invitation as messages
            EMClient.getInstance().chatManager().saveMessage(msg);
            // notify invitation message
        ...
        public void onMuteListRemoved(String groupId, List<String> mutes) {
            ...
            msg.setMsgId(UUID.randomUUID().toString());
            msg.setAttribute(DemoConstant.EM_NOTIFICATION_TYPE, true);
            msg.addBody(new EMTextMessageBody(context.getString(R.string.demo_group_listener_onMuteListRemoved, content)));
            msg.setStatus(EMMessage.Status.SUCCESS);
            // save invitation as messages
            EMClient.getInstance().chatManager().saveMessage(msg);
            // notify invitation message
        ...
        public void onAllMemberMuteStateChanged(String groupId, boolean isMuted) {
            ...
            msg.setMsgId(UUID.randomUUID().toString());
            msg.setAttribute(DemoConstant.EM_NOTIFICATION_TYPE, true);
            msg.addBody(new EMTextMessageBody(context.getString(isMuted ? R.string.demo_group_listener_onAllMemberMuteStateChanged_mute
        ...
        public void onAdminAdded(String groupId, String administrator) {
           ...
           // msg.setFrom(administrator);
            ...
            msg.setMsgId(UUID.randomUUID().toString());
            msg.setAttribute(DemoConstant.EM_NOTIFICATION_TYPE, true);
            msg.addBody(new EMTextMessageBody(context.getString(R.string.demo_group_listener_onAdminAdded, administrator)));
            msg.setStatus(EMMessage.Status.SUCCESS);
            // save invitation as messages
            EMClient.getInstance().chatManager().saveMessage(msg);
            // notify invitation message
        ...
        public void onAdminRemoved(String groupId, String administrator) {
            ...
            msg.setMsgId(UUID.randomUUID().toString());
            msg.setAttribute(DemoConstant.EM_NOTIFICATION_TYPE, true);
            msg.addBody(new EMTextMessageBody(context.getString(R.string.demo_group_listener_onAdminRemoved, administrator)));
            msg.setStatus(EMMessage.Status.SUCCESS);
            // save invitation as messages
            EMClient.getInstance().chatManager().saveMessage(msg);
            // notify invitation message
        ...
        public void onOwnerChanged(String groupId, String newOwner, String oldOwner) {
            ...
            msg.setMsgId(UUID.randomUUID().toString());
            msg.setAttribute(DemoConstant.EM_NOTIFICATION_TYPE, true);
            msg.addBody(new EMTextMessageBody(context.getString(R.string.demo_group_listener_onOwnerChanged, oldOwner, newOwner)));
            msg.setStatus(EMMessage.Status.SUCCESS);
            // save invitation as messages
            EMClient.getInstance().chatManager().saveMessage(msg);
            // notify invitation message
        ...
        public void onMemberJoined(String groupId, String member) {
            ...
            msg.setMsgId(UUID.randomUUID().toString());
            msg.setAttribute(DemoConstant.EM_NOTIFICATION_TYPE, true);
            msg.addBody(new EMTextMessageBody(context.getString(R.string.demo_group_listener_onMemberJoined, member)));
            msg.setStatus(EMMessage.Status.SUCCESS);
            // save invitation as messages
            EMClient.getInstance().chatManager().saveMessage(msg);
            // notify invitation message
        ...
        public void onMemberExited(String groupId, String member) {
            ...
            msg.setMsgId(UUID.randomUUID().toString());
            msg.setAttribute(DemoConstant.EM_NOTIFICATION_TYPE, true);
            msg.addBody(new EMTextMessageBody(context.getString(R.string.demo_group_listener_onMemberExited, member)));
            msg.setStatus(EMMessage.Status.SUCCESS);
            // save invitation as messages
            EMClient.getInstance().chatManager().saveMessage(msg);
            // notify invitation message
        ...
        public void onAnnouncementChanged(String groupId, String announcement) {
            ...
            msg.setMsgId(UUID.randomUUID().toString());
            msg.setAttribute(DemoConstant.EM_NOTIFICATION_TYPE, true);
            msg.addBody(new EMTextMessageBody(context.getString(R.string.demo_group_listener_onAnnouncementChanged_content, announcement)));
            msg.setStatus(EMMessage.Status.SUCCESS);
        ...
        public void onSharedFileAdded(String groupId, EMMucSharedFile sharedFile) {
            ...
            msg.setMsgId(UUID.randomUUID().toString());
            msg.setAttribute(DemoConstant.EM_NOTIFICATION_TYPE, true);
            msg.addBody(new EMTextMessageBody(context.getString(R.string.demo_group_listener_onSharedFileAdded, sharedFile.getFileName())));
            msg.setStatus(EMMessage.Status.SUCCESS);
            // save invitation as messages
            EMClient.getInstance().chatManager().saveMessage(msg);
            // notify invitation message
