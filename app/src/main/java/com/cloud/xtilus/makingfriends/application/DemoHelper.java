...
import com.cloud.xtilus.makingfriends.common.manager.UserProfileManager;
import com.cloud.xtilus.makingfriends.common.model.DemoModel;
import com.cloud.xtilus.makingfriends.common.model.EmojiconExampleGroupData;
import com.cloud.xtilus.makingfriends.common.receiver.HeadsetReceiver;
import com.cloud.xtilus.makingfriends.common.utils.PreferenceManager;
import com.cloud.xtilus.makingfriends.section.chat.ChatPresenter;
import com.cloud.xtilus.makingfriends.section.chat.activity.ChatActivity;
import com.cloud.xtilus.makingfriends.section.chat.activity.ChatVideoCallActivity;
import com.cloud.xtilus.makingfriends.section.chat.activity.ChatVoiceCallActivity;
import com.cloud.xtilus.makingfriends.section.chat.delegates.ChatConferenceInviteAdapterDelegate;
import com.cloud.xtilus.makingfriends.section.chat.delegates.ChatLiveInviteAdapterDelegate;
import com.cloud.xtilus.makingfriends.section.chat.delegates.ChatNotificationAdapterDelegate;
import com.cloud.xtilus.makingfriends.section.chat.delegates.ChatRecallAdapterDelegate;
import com.cloud.xtilus.makingfriends.section.chat.delegates.ChatVideoCallAdapterDelegate;
import com.cloud.xtilus.makingfriends.section.chat.delegates.ChatVoiceCallAdapterDelegate;
import com.cloud.xtilus.makingfriends.section.chat.receiver.CallReceiver;
...
public class DemoHelper {
    ...
    public void logoutSuccess() {
        Log.d(TAG, "logout: onSuccess");
        setAutoLogin(false);
        DemoDbHelper.getInstance(MakingFriendApplication.getInstance()).closeDb();
    }
    ...
    public DemoModel getModel(){
        if(demoModel == null) {
            demoModel = new DemoModel(MakingFriendApplication.getInstance());
        }
        return demoModel;
    }
     ...
     * @return EaseUser
     */
    public EaseUser getUserInfoByUserName(String username){
    ...
    public  void updateGroupName(String groupId,String groupName){
        ...
        UserCacheManager.updateGroupInfo(groupId,groupName);
    ...
    public synchronized int deleteContact(String username) {
        ...
        DemoDbHelper helper = DemoDbHelper.getInstance(MakingFriendApplication.getInstance());
