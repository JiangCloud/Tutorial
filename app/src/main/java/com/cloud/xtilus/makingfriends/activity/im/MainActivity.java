package com.cloud.xtilus.makingfriends.activity.im;
...
import com.cloud.xtilus.makingfriends.Fragment.MeFragment;
import com.cloud.xtilus.makingfriends.R;
import com.cloud.xtilus.makingfriends.application.DemoHelper;
import com.cloud.xtilus.makingfriends.application.HMSPushHelper;
...
import com.cloud.xtilus.makingfriends.common.permission.PermissionsManager;
import com.cloud.xtilus.makingfriends.common.permission.PermissionsResultAction;
import com.cloud.xtilus.makingfriends.section.MainViewModel;
...
import com.cloud.xtilus.makingfriends.section.conference.ConferenceActivity;
import com.cloud.xtilus.makingfriends.section.contact.activity.AddContactActivity;
import com.cloud.xtilus.makingfriends.section.contact.activity.GroupContactManageActivity;
import com.cloud.xtilus.makingfriends.section.contact.fragment.ContactListFragment;
import com.cloud.xtilus.makingfriends.section.contact.viewmodels.ContactsViewModel;
import com.cloud.xtilus.makingfriends.section.conversation.ConversationListFragment;
import com.cloud.xtilus.makingfriends.section.discover.DiscoverFragment;
import com.cloud.xtilus.makingfriends.section.group.activity.GroupPrePickActivity;
...
public class MainActivity extends BaseInitActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        // 可以动态显示隐藏相应
        //tabnavView.getMenu().findItem(R.id.em_main_nav_me).setVisible(false);
        switchToHome();
    ...
    private void initViewModel() {
        ...
        viewModel.getSwitchObservable().observe(this, response -> {
            ...
            }else if(response == R.string.em_main_title_discover){
                mTitleBar.setVisibility(View.GONE);
