...
import com.cloud.xtilus.makingfriends.section.chat.adapter.PickUserAdapter;
import com.cloud.xtilus.makingfriends.section.contact.viewmodels.ContactListViewModel;
...
public class ForwardMessageActivity extends BaseInitActivity implements OnRefreshListener, OnItemClickListener, EaseSidebar.OnTouchEventListener, EaseTitleBar.OnBackPressListener {
    ...
    private void finishChatActivity() {
        MakingFriendApplication.getInstance().getLifecycleCallbacks().finishTarget(ChatActivity.class);
    }
