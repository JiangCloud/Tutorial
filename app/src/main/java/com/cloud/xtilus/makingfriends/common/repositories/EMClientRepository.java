...
import com.cloud.xtilus.makingfriends.common.interfaceOrImplement.DemoEmCallBack;
...
public class EMClientRepository extends BaseEMRepository{
        ...
        return new NetworkOnlyResource<String>() {
            ...
            protected void createCall(@NonNull ResultCallBack<LiveData<String>> callBack) {
                ...
                if(!DemoHelper.getInstance().isSDKInit) {
                    DemoHelper.getInstance().init(MakingFriendApplication.getInstance());
     ...
     * @return
     */
    public LiveData<Resource<EaseUser>> loginToServer(String userName, String pwd, boolean isTokenFlag, JSONObject userJson) {
