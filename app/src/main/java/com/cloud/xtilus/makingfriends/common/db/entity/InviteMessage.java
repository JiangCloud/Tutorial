package com.cloud.xtilus.makingfriends.common.db.entity;
...
public class InviteMessage implements Serializable {
    ...
    public void setType(MsgTypeManageEntity.msgType type) {
        ...
        MsgTypeManageDao msgTypeManageDao = DemoDbHelper.getInstance(MakingFriendApplication.getInstance()).getMsgTypeManageDao();
