...
import com.cloud.xtilus.makingfriends.util.HttpsUtils;
            ...
            switch (reusltCode) {
                ...
                case RESULT_SUCESS:
                    ...
                    try {
                        ...
                        if (jsonObject != null && jsonObject.containsKey("ret_code") && jsonObject.containsKey("message")) {
                            if (jsonObject.getInteger("ret_code") == 0 && jsonObject.getString("message").contains("session")) {
...
//            // 小图
        ...
        params.add(new Param("userID", MakingFriendApplication.getInstance().getUsername()));
        for (Param param : params) {
