package com.cloud.xtilus.makingfriends.common.utils;
...
public class ToastUtils {
    ...
    public static void showCenterToast(String title, String message, int type, int duration) {
        ...
        showToast(MakingFriendApplication.getInstance(), title, message, type, duration, Gravity.CENTER);
    }
    ...
    public static void showBottomToast(String title, String message, int type, int duration) {
        ...
        showToast(MakingFriendApplication.getInstance(), title, message, type, duration, Gravity.BOTTOM);
    }
