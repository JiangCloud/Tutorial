...
import com.cloud.xtilus.makingfriends.common.utils.ViewScrollHelper;
...
public class VideoCallFragment extends EaseCallFragment implements View.OnClickListener {
    ...
    protected void initData() {
        ...
        //设置小窗口悬浮类型
        CallFloatWindow.getInstance(MakingFriendApplication.getInstance()).setCallType(CallFloatWindow.CallWindowType.VIDEOCALL);
    }
...
//                                        callStateTextView.setText(s6);
                            ...
                            CallFloatWindow.getInstance(MakingFriendApplication.getInstance()).dismiss();
                            postDelayedCloseMsg();
                            break;
                    }
                });
