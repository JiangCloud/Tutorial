...
import com.cloud.xtilus.makingfriends.section.group.adapter.GroupMemberAuthorityAdapter;
import com.cloud.xtilus.makingfriends.section.group.viewmodels.GroupMemberAuthorityViewModel;
            ...
            parseResource(response, new OnResourceParseCallback<Map<String, Long>>() {
                ...
                public void onSuccess(Map<String, Long> data) {
                    ...
                    if(flag == TYPE_MUTE) {
                        ...
                        GroupHelper.getUserInfo(muteMembers,adapter);
        ...
        viewModel.getBlackObservable().observe(this, response -> {
            parseResource(response, new OnResourceParseCallback<List<String>>() {
                ...
                public void onSuccess(List<String> data) {
                    ...
                    if(flag == TYPE_BLACK) {
                        GroupHelper.getUserInfo(blackMembers,adapter);
