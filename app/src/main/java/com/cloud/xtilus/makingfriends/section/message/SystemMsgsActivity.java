package com.cloud.xtilus.makingfriends.section.message;
...
import com.cloud.xtilus.makingfriends.section.message.delegates.AgreeMsgDelegate;
import com.cloud.xtilus.makingfriends.section.message.delegates.InviteMsgDelegate;
import com.cloud.xtilus.makingfriends.section.message.delegates.OtherMsgDelegate;
import com.cloud.xtilus.makingfriends.section.message.viewmodels.NewFriendsViewModel;
...
public class SystemMsgsActivity extends BaseInitActivity implements OnRefreshLoadMoreListener, InviteMsgDelegate.OnInviteListener, EaseTitleBar.OnBackPressListener {
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        msgDelegate = new InviteMsgDelegate(this);
        adapter.addDelegate(new AgreeMsgDelegate(this))
                .addDelegate(msgDelegate)
                .addDelegate(new OtherMsgDelegate(this));
