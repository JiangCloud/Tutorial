...
public class LoginFragmentViewModel extends AndroidViewModel {
     ...
     * @param isTokenFlag
     */
    public void login(String userName, String pwd, boolean isTokenFlag, JSONObject userJson) {




        loginObservable.addSource(mRepository.loginToServer(userName, pwd, isTokenFlag,userJson), response -> {
