...
import com.cloud.xtilus.makingfriends.common.enums.Status;
...
import com.cloud.xtilus.makingfriends.common.widget.EaseProgressDialog;
...
public class BaseActivity extends AppCompatActivity {
    ...
    protected void finishOtherActivities() {
        UserActivityLifecycleCallbacks lifecycleCallbacks = MakingFriendApplication.getInstance().getLifecycleCallbacks();
