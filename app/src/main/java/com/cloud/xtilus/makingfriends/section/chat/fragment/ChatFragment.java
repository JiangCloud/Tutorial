...
import com.cloud.xtilus.makingfriends.section.chat.activity.ForwardMessageActivity;
import com.cloud.xtilus.makingfriends.section.chat.activity.ImageGridActivity;
import com.cloud.xtilus.makingfriends.section.chat.activity.PickAtUserActivity;
...
import com.cloud.xtilus.makingfriends.section.contact.activity.ContactDetailActivity;
import com.cloud.xtilus.makingfriends.section.dialog.DemoDialogFragment;
import com.cloud.xtilus.makingfriends.section.dialog.DemoListDialogFragment;
import com.cloud.xtilus.makingfriends.section.dialog.FullEditDialogFragment;
...
public class ChatFragment extends EaseChatFragment implements OnRecallMessageResultListener {
    ...
    public void onUserAvatarClick(String username) {
        if(!TextUtils.equals(username, DemoHelper.getInstance().getCurrentUser())) {
            ...
            //DemoDbHelper.getInstance(mContext).getUserDao().loadAllUsers();
            //根据用户名获取用户信息
            EaseUser user=  DemoHelper.getInstance().getUserInfoByUserName(username);
