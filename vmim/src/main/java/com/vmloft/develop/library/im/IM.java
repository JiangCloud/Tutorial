...
public class IM {
    ...
    // IM 图片加载接口
    private VMPickerLoader mPictureLoader;
     ...
     * 初始化
     */
    public boolean init(Context context, IIMGlobalListener listener, VMPickerLoader loader) {
        mContext = context;
        // 获取当前进程 id 并取得进程名
     ...
     * 获取图片加载器
     */
    public VMPickerLoader getPictureLoader() {
