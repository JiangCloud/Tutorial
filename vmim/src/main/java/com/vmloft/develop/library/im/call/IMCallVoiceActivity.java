...
public class IMCallVoiceActivity extends IMCallActivity {
    ...
    private void setupContact() {
        VMPickerLoader.Options options = new VMPickerLoader.Options(mContact.mAvatar);
        options.isBlur = true;
        IM.getInstance().getPictureLoader().load(mActivity, options, mCoverView);

        options = new VMPickerLoader.Options(mContact.mAvatar);
        ...
        options = new VMPickerLoader.Options(mSelfContact.mAvatar);
        options.isCircle = true;
